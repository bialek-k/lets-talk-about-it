...
const MainTitle = ({ fill }: { fill: string }) => {
  return (
    <div className="flex justify-center flex-col items-center mx-auto w-full mb-5">
      <h2 className=" font-medium text-[32px] lg:text-[100px] leading-[43px] lg:leading-[130px] mt-5 text-center">
        LET’S TALK ABOUT IT
      </h2>
      <div className="relative flex justify-center">
        ...
        <h3 className=" font-normal text-base text-center leading-5 lg:text-5xl lg:leading-[62px]">
          Join us to rock IT
        </h3>
      </div>
    </div>
