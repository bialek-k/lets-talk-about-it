    ...
    if (flipped.length === 1) {
      ...
      setTimeout(() => {
        ...
        if (first.text === second.text && first.emoji === second.emoji) {
          setMatched((prev) => [...prev, firstIndex, i]);
          setPairs((p) => p + 1);
    ...
    <div className="min-h-screen p-6 bg-gradient-to-br from-black via-neutral-800 to-black flex flex-col items-center text-white">
      ...
      >
        {cards.map((item: CardItem, i: number) => {
          const isFlipped: boolean = flipped.includes(i) || matched.includes(i);
          ...
          return (
            <div
              ...
              className={`
                ...
                transition transform relative select-none text-center
                ${
                  isFlipped
                    ? "bg-neutral-900 border-white"
                    : "bg-neutral-700 border-lime-300"
                } 
                ${
                  matched.includes(i)
